...
def func_test_value():
  global user_number
#Prepare if inctruction to do the test 4 time
  for i in range (1,4):
...
def func_test_result(user_number,secret_number):
  if user_number == secret_number:
    print('Congratulations !!!')
  else:
    print('Sorry, maybe next time! The secret number is '+str(secret_number))
       
user_number = func_test_value()      
func_test_result(user_number,secret_number)
